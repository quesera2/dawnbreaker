...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m2(value, unit) => "定期 ${value}${unit}";

  static String m3(name) => "「${name}」を更新しました";

  static String m4(name) => "「${name}」を登録しました";

  static String m5(value, unit) => "${value}${unit}ごと";

  static String m6(name) => "「${name}」の完了を記録しました";

  static String m7(days) => "${days}日超過";

  static String m8(days) => "残り${days}日";
